<template>
  <div>
    <div class="vh-100">
      <div class="mask space-intro d-flex align-items-center h-100 gradient-custom-3 pb-5">
        <div class="container">
                ...
                <div class="card-body p-5">
                  ...
                  <form @submit.prevent="register">
                    <div class="form-outline mb-2">
                      ...
                      />
                      <span class="text-danger" v-for="(message, index) in error.first_name" :key="index">{{
                        message
                      }}</span>
                    </div>
                    ...
                    <div class="form-outline mb-2">
                      ...
                      <input
                        ...
                        class="form-control form-control-lg"
                      />
                      <span class="text-danger" v-for="(message, index) in error.last_name" :key="index">{{
                        message
                      }}</span>
                    </div>
                    ...
                    <div class="form-outline mb-2">
                      ...
                      <input
                        ...
                        class="form-control form-control-lg"
                      />
                      <span class="text-danger" v-for="(message, index) in error.email" :key="index">{{
                        message
                      }}</span>
                    </div>
                    ...
                    <div class="form-outline mb-2">
                      ...
                      <input
                        ...
                        required
                      />
                      <span class="text-danger" v-for="(message, index) in error.password" :key="index">{{
                        message
                      }}</span>
                    </div>
                    ...
                    <div class="form-outline mb-2">
                      ...
                      <input
                        ...
                        class="form-control form-control-lg"
                      />
                      <span class="text-danger" v-for="(message, index) in error.confirm" :key="index">{{
                        message
                      }}</span>
                    </div>

                    <div class="d-flex justify-content-center">
                      <button type="submit" class="btn btn-primary btn-block btn-lg text-white bg-gradient">
                        Register
                      </button>
                    </div>
