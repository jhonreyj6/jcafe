                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 mb-2">
                                                        ...
                                                        <div class="text-black-50 mb-1">Variant: {{ item.product_variant_details.value + item.product_variant_details.unit }}</div>
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="text-center">
                                            <button
                                                @click="stripe.state = true && this.orders.length"
