<template>
  <div>
    <div class="container space-intro mb-150">
      <div class="row mb-4">
        <div class="col-lg-6 mb-4" v-for="(game, index) in games.data" :key="index">
          <div class="border">
            <div class="d-flex flex-row">
              <div>
                <img
                  :src="displayGameImage(game.image)"
                  alt="Card image"
                  :title="game.name"
                  class=""
                  width="200"
      ...
      <div class="d-flex flex-row-reverse">
        <PaginateButton :data="games" @nextPage="nextPage" @prevPage="prevPage" @goToPage="goToPage" />
      </div>
    </div>
  </div>
</template>
